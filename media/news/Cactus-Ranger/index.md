...
OpenMP, using the shared memory capabilities of Ranger\'s nodes to
reduce the memory overhead of parallelisation. We are grateful for the
help we received from Ranger\'s support team and are looking forward to
using the full machine in the near future.
...
[![](Ranger.png){width="75%"}](Ranger.png)

### 15 Jan 2008 --- elena {#jan-2008-elena .align-right}
