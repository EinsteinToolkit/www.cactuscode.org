<?php $title='One day workshop organized by CCT and the NSF IGERT program';
...
<p>
	  <table>
	    <tr>
	      <td valign=center>Students from Lee High School and Glen Oaks High School in Baton Rouge attended the IGERT workshop, which took place beginning at 8 a.m. in the Frey Computing Services Center. The workshop introduced students to the tools scientists use to conduct research, particularly those used in high-performance computing for computational fluid dynamics. The workshop was primarily organized by the students in the IGERT program, as part of their training experience at LSU.
	      </td>
	      <td>
               <a align=left href="HSStudentsWorkshop.jpg"><img
		src="HSStudentsWorkshop.jpg" border=0 width="350" height="200" /></a>
	      </td>
	    </tr>
	  </table>
</p>
...
<p>
	  <table>
	    <tr>
        <td valign=center>Following the presentations, the students worked through two tutorials during the workshop. In a visualization tutorial, students learned to visualize results of a glaucoma computer model developed by the LSU Computational Fluid Dynamics group that simulates fluid flow and pressure distribution in the eye using the visualization software tool Amira. Students also took part in a high-performance computing tutorial using the Cactus Framework, running simulations of black holes on the large-scale computing resources of the Louisiana Optical Network Initiative.
	      </td>

	      <td>
	   	<a align=right href="CactusTutorialHSWorkshop.jpg"><img
		src="CactusTutorialHSWorkshop.jpg" border=0 width="300" height="200" /></a>
	      </td>
	    </tr>
	  </table>
</p>
