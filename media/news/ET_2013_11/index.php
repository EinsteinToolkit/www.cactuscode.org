<?php $title='Einstein Toolkit "Noether" release';
include_once($_SERVER['DOCUMENT_ROOT'].'/global/header.php');
?>

<p>We are pleased to announce the eighth release (code name
"<a href="http://en.wikipedia.org/wiki/Emmy_Noether">Noether</a>") of the
...
<h3 class="align-right">26 November 2013 — Frank Löffler</h3>
