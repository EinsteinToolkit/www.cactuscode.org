...
Raspberry Pi was straightforward; however a few tweaks were necessary due to the uncommon architecture
(a ARMv6 32-bit core), which is anticipated to be supported in the next release 
of Cactus.
</p>
...
Cactus runs for small-scale toy codes.  Our next goal is to support
a distributed setup using Raspberry Pis.
</p>
...
only change necessary to build Einstein Toolkit on a standard
...
followed by <b>dphys-swapfile swapon</b>).  </p>
