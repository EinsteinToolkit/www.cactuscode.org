...
[<img src="visit_alp.jpg" alt="VisIt Visualization" width="400" />](visit_alp.jpg)
[<img src="visit_wavetoy_volume.jpg" alt="VisIt Visualization" width="400" />](visit_wavetoy_volume.jpg)
...
[<img src="visitscreenshot1.jpg" alt="VisIt Visualization" width="400" />](visitscreenshot1.jpg)
...
[<img src="visitscreenshot2.jpg" alt="VisIt Visualization" width="400" />](visitscreenshot2.jpg)

Remote files are accessed in the "File/Open file..." dialog by choosing
the corresponding host:

[<img src="visitscreenshot3.jpg" alt="VisIt Visualization" width="400" />](visitscreenshot3.jpg)

Notice that the environment variable $VISITSSH controls which executable
VisIt invokes to log into the remote machine; this is particularly
useful if the remote machine is not accessible via ssh, but uses, e.g.,
Globus tools such as gsissh. Sometimes such passwordless logins also
require VisIt to not try and mediate between the user and the shell,
which can be obtained with the command-line flag -nopty.
...
output generated by the [Carpet](https://bitbucket.org/eschnett/carpet.git)
adaptive mesh-refinement (AMR) driver for Cactus. The datasets in the HDF5
...
your architecture is not among these, or the binary distribution doesn't
work for you, you can also download the sources and build VisIt
...
"-assume\_format CarpetHDF5" passed to VisIt ensures that all HDF5 files
are opened with this plugin.
