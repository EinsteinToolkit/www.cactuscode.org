...
Seidel's group of researchers at the National Center for
Supercomputing Applications (NCSA) as the group wrestled to
numerically solve Einstein's Equations for General Relativity and thus
model black holes, neutron stars, and boson stars.
</p>
...
such a way that it could be used not just by numerical relativists,
but also by other computational scientists in other domains with
...
has happened since 1999.  Cactus has been adopted not just by
application developers, but also by computer science researchers, and
has been involved in many prize winning efforts for large scale
computing, grid computing and high speed networks.  More information
about these awards can be found on our News pages.
</p>
