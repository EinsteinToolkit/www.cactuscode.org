...
<p>This benchmark is similar to Bench_BSSN_Carpet, but it solves the relativistic Euler equations in addition to the Einstein equations. This requires more memory and more floating point operations per grid point. The relativistic Euler equations are implemented in the Whisky code. You find more information on Whisky on its <a href="http://www.whiskycode.org/">web pages</a>.</p>

<p>This benchmark comes in two sizes, <kbd>36l</kbd> and <kbd>48l</kbd>, which use about 400 MB and 800 MB of main memory per CPU, and consume approximately 265.9 GFlop and 312.8 GFlop, respectively. You should run both sizes if you have enough memory.</p>
